...
export const metadata: Metadata = {
  title: "Menu — Tamarind Branch 2",
  description: "Explore our 100% pure vegetarian menu from Tamarind Branch 2.",
}

export const dynamic = "force-dynamic"

export default async function MenuPage() {
  const menuData = await getMenuItemsByBranch(2)
      ...
      <main className="flex-1">
        <section className="border-b border-border/60 bg-gradient-to-b from-green-50/50 to-background dark:from-green-950/10">
          <div className="mx-auto max-w-6xl px-4 py-14 text-center sm:px-6">
            ...
            <h1 className="mt-4 font-serif text-4xl font-bold sm:text-5xl">Tamarind Branch 2</h1>
